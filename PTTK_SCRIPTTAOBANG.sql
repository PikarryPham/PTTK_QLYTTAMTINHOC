...
CREATE TABLE NGUOIDANGKYTHI (
	 ...
	 check(NDKT_LOAI in (N'Học Viên', N'Giảng viên',N'Khác')),
...
CREATE TABLE HOCPHANBATBUOC(
	HP_IDCB INT NOT NULL,
	HP_IDCS INT NOT NULL,
...
ALTER TABLE PHANCONGGIANGDAY
	...
	ON DELETE CASCADE;
ALTER TABLE HOCPHANBATBUOC
	ADD CONSTRAINT FK_HPBB_COBAN
	FOREIGN KEY (HP_IDCB) REFERENCES HOCPHAN
ALTER TABLE HOCPHANBATBUOC
	ADD CONSTRAINT FK_HPBB_CS
	FOREIGN KEY (HP_IDCS) REFERENCES HOCPHAN
